    ...
    setChart(data) {
        ...
        Axios.get('/obsvData/data', {params})
            .then((res) => {
                ...
                ComnChart('chartdiv1', "수위(EL.m)", 'EL', chartData, xAixis);
                for(let i=0; i<res.data.data.length; i++) {
                ...
                ComnChart('chartdiv2', "수위(GL.m)", '시간', chartData, xAixis);
                ...
                ComnChart('chartdiv3', "수온(℃)", '시간', chartData, xAixis);
                ...
                ComnChart('chartdiv4', "EC(μS/cm)", '시간', chartData, xAixis);
